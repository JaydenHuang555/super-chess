package jay.chess.classic.engine;
...
import jay.chess.classic.starting.ClassicalChessStartingConfiguration;
...
public class ClassicalChessEngine extends ChessEngine {
